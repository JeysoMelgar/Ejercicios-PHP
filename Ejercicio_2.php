...
<?php
    ...
    */ 
    ...
    echo "<body>";
    echo "<h2>Esta es la clase de $NombreClase manana y tarde (Simbolo) </h2>" ;
    ...
    $logico = true;
    $logico2 = false;
    echo "<p> El contenido de una variable tipo booleano verdadero: $logico y variable boolena falsa:$logico2 </p>";
